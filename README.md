...
* 🔵 Phase 4: Forensics (Wireshark) — PLANNED
...
* 🏷️ Threat Signature Mapping: Inspect network packet flags and raw hex bytes during simulated scanning loops to analyse attack patterns before they hit logs.

* 📈 Correlation with IPS: Cross‑reference Wireshark captures with Fail2Ban logs to validate automated blocking decisions.
